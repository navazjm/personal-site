  ...
  return (
    <div className="about-page-container" id="about">
      ...
      <div className="about-page-content">
        <p>
          Once I coded my first &quot;Hello, World!&quot; application, I was
          hooked. Giving a computer instructions to do whatever I wanted by
          typing keywords and funny symbols felt magical. From there I got my
          hands dirty and began building as many projects as I could. I finally
          found something that I was passionate about.
        </p>
        <img
          src={profilePic}
