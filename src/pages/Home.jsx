...
import { CirclesBackgroundAnimation } from "../components/Home/CirclesBackgroundAnimation";
import { MouseScrollAnimation } from "../components/Home/MouseScrollAnimation";
    ...
    useEffect(() => {
        ...
        window.addEventListener("scroll", () => {
            ...
            const sideNavbarLinks =
                document.querySelectorAll(".side-navbar-link");
        ...
        <>
            ...
            <div className="container">
                <div className="home-container" id="home">
                    <div className="home-heading">
                        <div>
                            ...
                            <h4 className="home-heading-role">
                                Software Engineer
                            </h4>
                        </div>
                ...
                <ExperienceList
                    ...
                    description={
                        "Collection of open source and personal projects."
                    }
                    data={ProjectsData}
                />
                <Footer />
